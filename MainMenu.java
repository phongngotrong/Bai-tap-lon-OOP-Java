...
public class MainMenu extends JFrame implements Runnable {
    ...
    public MainMenu() {
        ...
        this.exitGame = new Text("Exit", new Font("Times New Roman", Font.PLAIN, 40),
                Constants.SCREEN_WIDTH / 2.0 - 50.0, Constants.SCREEN_HEIGHT / 1.5 - 30, Color.WHITE);
        this.startGame = new Text("Play Game", new Font("Times New Roman", Font.PLAIN, 40),
                Constants.SCREEN_WIDTH / 2.0 - 90.0, Constants.SCREEN_HEIGHT / 2.0, Color.WHITE);
        this.pong = new Text("PONG", new Font("Arial", Font.PLAIN, 100),
                Constants.SCREEN_WIDTH / 2.0 - 150.0, 180, Color.WHITE);
